...
define(["./feature_computation", "vega", "vega-embed"], function(
    ...
    class RRVDisplay {
        ...
        /* Downloads an image URL generated by Vega using an existing <a> tag.
         * Based on https://vega.github.io/vega/docs/api/view/#view_background.
         */
        static downloadImageURL(url, linkID) {
        ...
        takeScreenshot() {
            ...
            this.rankPlotView.toImageURL("png").then(function(url) {
                RRVDisplay.downloadImageURL(url, "rankPlotURLLink");
            });
            this.samplePlotView.toImageURL("png").then(function(url) {
                RRVDisplay.downloadImageURL(url, "samplePlotURLLink");
            });
        }
